...
TOOCLOSE_DISTANCE = 50 # measure in mm
NO_OBSTACLE = 3000
...
def Main():
    ...
    while robot_operating:
        ...
        elif current_distance < MIN_DISTANCE and current_distance > TOOCLOSE_DISTANCE:
            # then stop the GoPiGo3
            gopigo3_stationary = True
            gopigo3.stop()
        
        # if the robot is TOO close to the target (mainting a certain distance)
